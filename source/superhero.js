...
// Escapes HTML symbols
	...
	messages: [
		...
		{
			msg_no: 5,
			title: 'Godville UI+: Улучшение форумных кнопок',
			content: '<div style="text-align: justify;">' +
					 '&emsp;Теперь после нажатия на кнопки форматирования курсор остается в поле ввода.\n' +
					 'А еще можно цитировать текст прямо со страницы! Попробуйте выделить кусок текста на странице, а потом нажать на кнопку форматирования.' +
					 '</div>'+
					 '<div style="text-align: right;">Круто, правда?.<br>~~Бэдлак</div>'
		}
		/*{
			msg_no: 6, // 1..5 are used
