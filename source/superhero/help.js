...
GUIp.help._createHelpDialog = function() {
	document.getElementById('menu_bar').insertAdjacentHTML('afterend',
		'<div id="GUIp.help" class="hint_bar" style="padding-bottom: 0.7em; display: none;">' +
	...
	if (GUIp.storage.get('helpDialogVisible')) { document.getElementById('GUIp.help').style.display = 'block'; }
};
GUIp.help._createButtons = function() {
	var menu_bar = document.querySelector('#menu_bar ul');
	menu_bar.insertAdjacentHTML('beforeend', '| <li><a href="user/profile#GUIp.settings">' + GUIp.i18n.guip_settings_top_menu + '</a></li> | <li></li>');
	...
	GUIp.help._addToggleButton(document.getElementsByClassName('hint_bar_close')[0], GUIp.i18n.close);
};
// gets toggle button
