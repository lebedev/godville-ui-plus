...
(isEN ? '' : '			<input class="item-informer informer-checkbox" id="catch_box" name="catch_box" type="checkbox"><label for="catch_box">' + GUIp.i18n.forbidden_informers_catch_box + '</label><br>\n') +
