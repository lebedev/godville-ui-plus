...
GUIp.getPhrases = function() {
    ...
    usableItemTypes: [
        {
            name: 'aura box',
            description: 'Этот предмет наделяет героя случайной аурой'
        },
        {
            name: 'arena box',
            description: 'При активации этого предмета в дуэли герои перестанут промахиваться и начнут биться в полную силу'
        },
        {
            name: 'black box',
            description: 'Этот предмет может случайным образом повлиять на героя'
        },
        {
            name: 'boss box',
            description: 'Этот предмет ищет для героя босса'
        },
        {
            name: 'catch box',
            description: 'Внутри может найтись как ерунда, так и что-то ценное',
            condition: function(item) { return item.needs_godpower === 0; }
        },
        {
            name: 'charge box',
            description: 'Этот предмет добавляет заряд в прано-аккумулятор'
        },
        {
            name: 'coolstory box',
            description: 'Этот предмет сочиняет о герое былину'
        },
        {
            name: 'friend box',
            description: 'Этот предмет заводит герою случайного друга из числа активных героев'
        },
        {
            name: 'gift box',
            description: 'Этот предмет можно превратить во что-то хорошее'
        },
        {
            name: 'good box',
            description: 'Активация этого предмета может преподнести герою приятный сюрприз'
        },
        {
            name: 'invite',
            description: 'Активация инвайта увеличит счетчик доступных приглашений'
        },
        {
            name: 'heal box',
            description: 'Этот предмет полностью восстанавливает здоровье героя'
        },
        {
            name: 'raidboss box',
            description: 'Этот предмет на несколько минут отправляет героя в поиск соратников для битвы с ископаемым боссом'
        },
        {
            name: 'smelter',
            description: 'Этот предмет убивает атакующего героя монстра, либо пытается выплавить из золота героя золотой кирпич'
        },
        {
            name: 'teleporter',
            description: 'Этот предмет телепортирует героя в случайный город'
        },
        {
            name: 'temper box',
            description: 'Этот предмет делает характер героя немного ярче'
        },
        {
            name: 'to arena box',
            description: 'Этот предмет отправляет героя на арену'
        },
        {
            name: 'transformer',
            description: 'Этот предмет превращает один или несколько жирных предметов из инвентаря героя в золотые кирпичи'
        },
        {
            name: 'treasure box',
            description: 'Внутри может найтись как ерунда, так и что-то ценное',
        ...
        {
            name: 'quest box',
            description: 'Этот предмет отправляет героя в мини-квест'
        },
    ],
...
GUIp.i18n = {
    ...
    guip_settings_top_menu: 'настройки <strong>ui+</strong>',
    ...
    guip_settings_capt: 'Настройки Godville UI+',
    ...
    forbidden_informers_treasure_box: 'улов с заплыва',
