...
pageMod.PageMod({
	...
	contentScriptFile: [data.url('common.js'), data.url('guip_firefox.js'), data.url('phrases_ru.js'), data.url('log.js')],
	contentScriptWhen: 'ready'
});
...
pageMod.PageMod({
	...
	contentScriptFile: [data.url('common.js'), data.url('guip_firefox.js'), data.url('phrases_en.js'), data.url('log.js')],
	contentScriptWhen: 'ready'
});