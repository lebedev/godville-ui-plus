function getWords() {
	...
	phrases: {
		...
		exp: [
			...
			"Учись как лось, чтоб желание сбылось!", "Научись соображать, а не только дико ржать.", "Оптимизируй своё время, ум и опыт — тяжкое бремя.",
			"Чтобы светили большие зарплаты, больше учись и пиши рефераты!", "Не гадай на гуще кофейной, опыт ищи идейный!",
			"Знания впитывай, опыт ищи! Пройдут у тебя геморрой и прыщи!", "Опыт в жизни пригодится. Продолжай, герой, учиться!",
			"Опыт вбирай во все тела концы! В пятки, в сопатку, в лоб и резцы!", "Надо учиться и опыт качать, пользу от знаний всю жизнь получать!",
			"Раз-два, раз-два! Ум качай, а не права!", "Учись, набирайся опыта! Попрошу без лишнего ропота!",
			"Опыт прокачивай, впитывай знания – так учат потомков седые предания."
		],
		...
		dig: [
			...
			"Копай мне золота бурдюк, разбогатеем как индюк.", "Покопайся в голове, кладезь мудрости своей.", "Прикладные искусства - золотые русла.",
			"К тебе не подкопаться - кладезь информации.", "Складной ножик всем поможет.", "Кладка яиц - дело синиц.", "Золотой покрой - клад, а не герой.",
			"Ищи свой путь, копай жуть.", "Золотухой не страдай, лучше резво ты копай.", "Клад ищи! Копай лопатой! Будешь как Мидас богатый!",
			"Копай хоть лопатой, хоть молотом! Клад ищи, да сундук с золотом!", "Копай метро, траншеи рой! Сундук ищи, затем второй!",
			"Рой под деревом землицу! Клад случайный пригодится!", "Ищи золотую руду! Копай клад, забудь ерунду!", "Золотой сундук – награда для рук!",
			"Нужно золото, копай! Землю киркой наподдай!", "Сила – в золоте и кладе. Землю рой вперед и сзади!",
			"Копай с рассвета до обеда! Найди сундук, позли соседа!"
		],
