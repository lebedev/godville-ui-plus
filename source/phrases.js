function getWords() {
	...
	"phrases" : {
		...
		"defend" : [
			"Отбивайся!", "Отбивай!", "Сделай отбивную из удара врага!", "Постарайся отбить!", "Соверши отбив!", "Отбивание - мать выживания!",
			"Приготовь свой отбивной щит!", "Щитуй!", "Подними щиты!", "Защищайся, как никто доселе не защищался!", "Подразни врага щитом!",
			"Повысь уровень защиты!", "Используй защиту в этом бою!"
		],
