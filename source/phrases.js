function getWords() {
	...
	phrases: {
		...
		walk_n: [
			"Север!", "Север?", "Север ↑", "Север (↑)", "А мы пойдём на север! А мы пойдём на север!", "Ух, какая северянка."
		],

		// Ключевые корни: Юг
		walk_s: [
			"Юг!", "Юг?", "Юг ↓", "Юг (↓)", "Птицы летят на юг.", "Летим на юг, в жаркие края."
		],

		// Ключевые корни: Запад
		walk_w: [
			"Запад!", "Запад?", "Запад ←", "Запад (←)", "Западня!", "Западло дальше идти?"
		],

		// Ключевые корни: Восток
		walk_e: [
			"Восток!", "Восток?", "Восток →", "Восток (→)", "Проверь кровосток.", "Восток - дело тонкое."
		],
