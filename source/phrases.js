function getWords() {
	...
	pets: [
		...
		{name: 'бармаглот', min_level: 50, max_level: 64},
		{name: 'биоволк', min_level: 40, max_level: 54},
		{name: 'бурундук-шатун', min_level: 25, max_level: 39},
		{name: 'быкинг', min_level: 110},
		{name: 'василиск прекрасный', min_level: 60, max_level: 74},
		{name: 'ведмедь', min_level: 80},
		{name: 'вездекот', min_level: 40, max_level: 54},
		{name: 'вхламинго', min_level: 75, max_level: 89},
		{name: 'гипноманул', min_level: 18, max_level: 39},
		{name: 'гидравлиск', min_level: 80},
		{name: 'дракошка', min_level: 45, max_level: 59},
		{name: 'дьяволк', min_level: 80},
		{name: 'ездовой академик', min_level: 80},
		{name: 'ерундук', min_level: 18},
		{name: 'ехиднорог', min_level: 30, max_level: 31},
		{name: 'загрызаяц', min_level: 25, max_level: 39},
		{name: 'злось', min_level: 70},
		{name: 'йети подземелья', min_level: 100},
		{name: 'каннский лев', min_level: 65, max_level: 79},
		{name: 'карликовый дракон', min_level: 40, max_level: 54},
		{name: 'котопёс', min_level: 26, max_level: 42},
		{name: 'ломокотив', min_level: 65, max_level: 79},
		{name: 'многоногий сундук', min_level: 50, max_level: 64},
		{name: 'мозговой слизень', min_level: 18, max_level: 35},
		{name: 'наномедвед', min_level: 35, max_level: 49},
		{name: 'неверморж', min_level: 100},
		{name: 'огнегривый лев', min_level: 75, max_level: 89},
		{name: 'огнелис', min_level: 34, max_level: 49},
		{name: 'песочный сфинкс', min_level: 70, max_level: 83},
		{name: 'пожираф', min_level: 65, max_level: 80},
		{name: 'потолковый лампожуй', min_level: 18, max_level: 39},
		{name: 'почеширский кот', min_level: 18, max_level: 34},
		{name: 'пухозаврик', min_level: 18, max_level: 34},
		{name: 'саблекрыс', min_level: 25, max_level: 39},
		{name: 'саблепузый тигр', min_level: 40, max_level: 54},
		{name: 'семиногий единорог', min_level: 50, max_level: 73},
		{name: 'серверный олень', min_level: 40, max_level: 54},
		{name: 'сиамский ковродёр', min_level: 25, max_level: 40},
		{name: 'слонопотам', min_level: 112},
		{name: 'субтигр', min_level: 91},
		{name: 'троянский конь', min_level: 40, max_level: 54},
		{name: 'ультралис', min_level: 40, max_level: 54},
		{name: 'хатуль мадан', min_level: 32, max_level: 47},
		{name: 'хомячок-берсеркер', min_level: 33, max_level: 49},
		{name: 'хохмяк', min_level: 25, max_level: 39},
		{name: 'хрюкотательный зелюк', min_level: 18, max_level: 34},
		{name: 'хтонический шушпанчик', min_level: 60, max_level: 74},
		{name: 'ядрёнорог', min_level: 34, max_level: 49}
	]
	};
}